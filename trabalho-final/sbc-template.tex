...
Em seguida, preparamos a base para a aplicação do algoritmo de regressão.
Depois disso, amparados na análise estatística previamente realizada, desenvolvemos uma versão inicial do algoritmo de regressão.
