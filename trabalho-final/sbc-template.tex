...
Na etapa de classificação, utilizamos o algoritmo \emph{k-Nearest Neighbors} (\emph{k-NN}).
Durante o treinamento desse algoritmo, todas as observações do conjunto de teste são convertidas em vetores no espaço de características.
...
%todos os atributos relevantes (necessariamente numéricos) são convertidos
