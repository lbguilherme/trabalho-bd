...
Os gráficos evidenciam que, em geral, a acurácia do algoritmo aumenta com o valor de $k$.

\begin{figure}[H]
\centering\includegraphics[width=.65\linewidth]{../tab1.png}
\caption{Análise dos resultados obtidos pelo \emph{k-NN} com k=1.}
\label{fig:tab1}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[width=.65\linewidth]{../tab10.png}
\caption{Análise dos resultados obtidos pelo \emph{k-NN} com k=10.}
\label{fig:tab10}
\end{figure}

\begin{figure}[H]
\centering\includegraphics[width=.65\linewidth]{../tab100.png}
